...
#
leiden_2_050 = as.character(eval(parse(text = paste0("py$", adata_str, "")))$obs[['leiden_2_050']])
#
cell_annotation[leiden_2_050 == "0"] = "MUR - Pericyte (RERGL/NR4A2)"
cell_annotation[leiden_2_050 == "1"] = "MUR - Pericyte (HAS2/CYP26B1)"
cell_annotation[leiden_2_050 == "2"] = "MUR - Pericyte (CXCL12/FHL2/GGT5)"
cell_annotation[leiden_2_050 == "3"] = "MUR - Pericyte (RERGL)"
cell_annotation[leiden_2_050 == "4"] = "MUR - Bridge"
cell_annotation[leiden_2_050 == "5"] = "MUR - Pericyte (RGS5)"
cell_annotation[leiden_2_050 == "6"] = "MUR - Smooth Muscle Cell (DES/ACTG2)"
cell_annotation[leiden_2_050 == "7"] = "MUR - Pericyte (RGS5/RASD1/TCIM)"
cell_annotation[leiden_2_050 == "8"] = "MUR - MIX(KC)"
cell_annotation[leiden_2_050 == "9"] = "MUR - MIX(KC)"
cell_annotation[leiden_2_050 == "10"] = "MUR - MIX(FIB)"
cell_annotation[leiden_2_050 == "11"] = "MUR - MIX(LYM)"
cell_annotation[leiden_2_050 == "12"] = "MUR - MIX(MYE)"
#
...
py_run_string("marker_dict = {
  'MUR - Pericyte (RERGL/NR4A2)': ['RERGL', 'NR4A2'],
  'MUR - Pericyte (HAS2/CYP26B1)': ['HAS2', 'CYP26B1'],
  'MUR - Pericyte (CXCL12/FHL2/GGT5)': ['CXCL12', 'FHL2', 'GGT5'],
  'MUR - Pericyte (RERGL)': [],
  'MUR - Bridge': [],
  'MUR - Pericyte (RGS5)': ['RGS5'],
  'MUR - Smooth Muscle Cell (DES/ACTG2)': ['DES', 'ACTG2'],
  'MUR - Pericyte (RGS5/RASD1/TCIM)': ['RASD1', 'TCIM'],
  'MUR - MIX(KC)': ['KRT5', 'KRT14'],
  'MUR - MIX(FIB)': ['LUM', 'VCAN'],
  'MUR - MIX(LYM)': ['CD52', 'PTPRC'],
  'MUR - MIX(MYE)': ['CD74', 'HLA-DRA']
}")
...
py$index_name_dict = list(
  "0" = "MUR - Pericyte (RERGL)",
  "1" = "MUR - Pericyte (RERGL/NR4A2)",
  "2" = "MUR - Pericyte (RGS5)",
  "3" = "MUR - Pericyte (RGS5/RASD1/TCIM)",
  "4" = "MUR - Pericyte (HAS2/CYP26B1)",
  "5" = "MUR - Pericyte (CXCL12/FHL2/GGT5)",
  "6" = "MUR - Bridge",
  "7" = "MUR - Smooth Muscle Cell (DES/ACTG2)",
  "8" = "MUR - MIX(FIB)",
  "9" = "MUR - MIX(MYE)",
  "10" = "MUR - MIX(LYM)",
  "11" = "MUR - MIX(KC)"
...
py_run_string("color_dict={'0': colorsys.hsv_to_rgb(0.9, 1, 0.7),
                           ...
                           '2': colorsys.hsv_to_rgb(0.1, 1, 0.7),
                           '3': colorsys.hsv_to_rgb(0.1, 0.9, 0.9),
                           '4': colorsys.hsv_to_rgb(0.3, 1, 0.7),
                           '5': colorsys.hsv_to_rgb(0.3, 0.7, 0.4),
                           '6': colorsys.hsv_to_rgb(0.5, 0.6, 0.6),
                           '7': colorsys.hsv_to_rgb(0.7, 1, 0.7),
                           '8': colorsys.hsv_to_rgb(0, 0.05, 0.9),
                           '9': colorsys.hsv_to_rgb(0.25, 0.05, 0.9),
                           '10': colorsys.hsv_to_rgb(0.5, 0.05, 0.9),
                           '11': colorsys.hsv_to_rgb(0.75, 0.05, 0.9)
                          }")
